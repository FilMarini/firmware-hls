...
template<TF::seed Seed> constexpr bool isDiskSeed() {
  return (InnerRegion<Seed>()==DISKPS);
}
namespace TC {
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  template<TF::seed Seed> bool overlapSeeding(const AllStub<InnerRegion<Seed>()> &innerStub, const AllStub<OuterRegion<Seed>()> &outerStub, Types::rinv * const rinv, TrackletParameters::PHI0PAR * const phi0, Types::z0 * const z0, TrackletParameters::TPAR * const t, Types::phiL phiL[4], Types::zL zL[4], Types::der_phiL * const der_phiL, Types::der_zL * const der_zL, Types::flag valid_proj[4], Types::phiD phiD[4], Types::rD rD[4], Types::der_phiD * const der_phiD, Types::der_rD * const der_rD, Types::flag valid_proj_disk[4]);
  template<TF::seed Seed> bool diskSeeding(const bool negZ, const AllStub<InnerRegion<Seed>()> &innerStub, const AllStub<OuterRegion<Seed>()> &outerStub, Types::rinv * const rinv, TrackletParameters::PHI0PAR * const phi0, Types::z0 * const z0, TrackletParameters::TPAR * const t, Types::phiL phiL[4], Types::zL zL[4], Types::der_phiL * const der_phiL, Types::der_zL * const der_zL, Types::flag valid_proj[4], Types::phiD phiD[4], Types::rD rD[4], Types::der_phiD * const der_phiD, Types::der_rD * const der_rD, Types::flag valid_proj_disk[4]);
  ...
  template<uint8_t NSPMem, bool isDiskSeed> void
  getIndices(
      const BXType bx,
      const StubPairMemory<isDiskSeed> stubPairs[NSPMem],
      TC::Types::nSPMem &iSPMem,
      TC::Types::nSP &iSP,
      bool &done
  );

  template<TF::seed Seed, uint32_t TPROJMaskBarrel, uint32_t TPROJMaskDisk> void
  processStubPair(
      const BXType bx,
      const typename StubPair<isDiskSeed<Seed>()>::SPInnerIndex innerIndex,
      const AllStub<InnerRegion<Seed>()> &innerStub,
      const typename StubPair<isDiskSeed<Seed>()>::SPOuterIndex outerIndex,
      const AllStub<OuterRegion<Seed>()> &outerStub,
...
TrackletCalculator(
    ...
    const StubPairMemory<isDiskSeed<Seed>()> stubPairs[],
    BXType& bx_o,
    TrackletParameterMemory * const trackletParameters,
...
template<TF::seed Seed> bool
TC::barrelSeeding(const AllStub<InnerRegion<Seed>()> &innerStub, const AllStub<OuterRegion<Seed>()> &outerStub, TC::Types::rinv * const rinv, TrackletParameters::PHI0PAR * const phi0, TC::Types::z0 * const z0, TrackletParameters::TPAR * const t, TC::Types::phiL phiL[4], TC::Types::zL zL[4], TC::Types::der_phiL * const der_phiL, TC::Types::der_zL * const der_zL, TC::Types::flag valid_proj[4], TC::Types::phiD phiD[4], TC::Types::rD rD[4], TC::Types::der_phiD * const der_phiD, TC::Types::der_rD * const der_rD, TC::Types::flag valid_proj_disk[4])
{
...
template<TF::seed Seed> bool
TC::overlapSeeding(const AllStub<InnerRegion<Seed>()> &innerStub, const AllStub<OuterRegion<Seed>()> &outerStub, TC::Types
::rinv * const rinv, TrackletParameters::PHI0PAR * const phi0, TC::Types::z0 * const z0, TrackletParameters::TPAR * const t, TC::Types::phiL phiL[4], TC::Types::zL zL[4], TC::Types::der_phiL * const der_phiL, TC::Types::der_zL * const der_zL, TC::Types::flag valid_proj[4], TC::Types::phiD phiD[4], TC::Types::rD rD[4], TC::Types::der_phiD * const der_phiD, TC::Types::der_rD * const der_rD, TC::Types::flag valid_proj_disk[4])
{
  ...
  bool negZ = (innerStub.getZ()>0);
  TC::Types::zmean z2mean= negZ ? zmean[TF::D1] : (-zmean[TF::D1]);
  ...
  calculate_LXD1<Seed, InnerRegion<Seed>(), OuterRegion<Seed>()>(
      innerStub.getR(),
      innerStub.getPhi(),
      innerStub.getZ(),
      outerStub.getR(),
...
template<TF::seed Seed> bool
TC::diskSeeding(const bool negZ, const AllStub<InnerRegion<Seed>()> &innerStub, const AllStub<OuterRegion<Seed>()> &outerStub, TC::Types
::rinv * const rinv, TrackletParameters::PHI0PAR * const phi0, TC::Types::z0 * const z0, TrackletParameters::TPAR * const t, TC::Types::phiL phiL[4], TC::Types::zL zL[4], TC::Types::der_phiL * const der_phiL, TC::Types::der_zL * const der_zL, TC::Types::flag valid_proj[4], TC::Types::phiD phiD[4], TC::Types::rD rD[4], TC::Types::der_phiD * const der_phiD, TC::Types::der_rD * const der_rD, TC::Types::flag valid_proj_disk[4])
{
  TC::Types::rmean r1mean, rproj[3];
  ...
  if (Seed==TF::D1D2){
    z1mean = negZ ? (-zmean[TF::D1]-1) : zmean[TF::D1];
    z2mean = negZ ? (-zmean[TF::D2]-1) : zmean[TF::D2];
    zproj[0] = zmean[TF::D3];
    zproj[1] = zmean[TF::D4];
    zproj[2] = zmean[TF::D5];
  }
  else{
    z1mean = negZ ? (-zmean[TF::D3]-1) : zmean[TF::D3];
    z1mean = negZ ? (-zmean[TF::D4]-1) : zmean[TF::D4];
    zproj[0] = zmean[TF::D1];
    zproj[1] = zmean[TF::D2];
    zproj[2] = zmean[TF::D5];

  }
  calculate_DXDY<Seed, InnerRegion<Seed>(), OuterRegion<Seed>()>(
      innerStub.getR(),
      innerStub.getPhi(),
      innerStub.getZ(),
      outerStub.getR(),
...
#pragma HLS unroll
    ...
    bool valid_r=rD[i] >= 342 && rD[i] < 2048;
    valid_proj_disk[i] = valid_t && valid_phimin && valid_phimax && valid_r;}
  std::cout<< "r1 phi1 z1 "<< innerStub.getR() << " " << innerStub.getPhi()<< " " << innerStub.getZ() << " "  <<std::endl;//FIXME
  std::cout<< "r2 phi2 z2 "<< outerStub.getR() << " " << outerStub.getPhi()<< " " << outerStub.getZ() << " "  <<std::endl;//FIXME
...
// Calculate the tracklet parameters and projections.
  ...
  if (Seed == TF::L1L2 || Seed == TF::L2L3 || Seed == TF::L3L4 || Seed == TF::L5L6)
    ...
    success = TC::overlapSeeding<Seed>(innerStub, outerStub, &rinv, &phi0, &z0, &t, phiL, zL, &der_phiL, &der_zL, valid_proj, phiD, rD, &der_phiD, &der_rD, valid_proj_disk);
    stubIndex1 = outerIndex;
    stubIndex2 = innerIndex;}
    //stub indices are reversed on overlap seeds for some reason.
  else {
    success = TC::diskSeeding<Seed>(negZ, innerStub, outerStub, &rinv, &phi0, &z0, &t, phiL, zL, &der_phiL, &der_zL, valid_proj, phiD, rD, &der_phiD, &der_rD, valid_proj_disk);
  
  }
// Write the tracklet parameters and projections to the output memories.
  // FIXME std::cout<< std::hex << (outerIndex,innerIndex) <<" "<<success<<std::dec<<std::endl;  
  ...
  if (Seed == TF::L1D1){
    ...
    TC::addProj<DISK, nproj_D2, ((TPROJMaskDisk & mask_D2) >> shift_D2)> (tproj_D2, bx, &projout_disk[D2PHIA], &nproj_disk[D2PHIA], success && valid_proj_disk[1]);
    TC::addProj<DISK, nproj_D5, ((TPROJMaskDisk & mask_D5) >> shift_D5)> (tproj_D5, bx, &projout_disk[D5PHIA], &nproj_disk[D5PHIA], success && valid_proj_disk[2]);
  }
 //Barrel Seeds
 else if (Seed == TF::L1L2 || Seed == TF::L2L3 || Seed == TF::L3L4 || Seed == TF::L5L6){
    switch (Seed) {
      case TF::L1L2:
        {
...
{
  //static_assert(Seed == TF::L1L2 || Seed == TF::L2L3 || Seed == TF::L3L4 || Seed == TF::L5L6 ||TF::L1D1, "Only L1L2, L2L3, L3L4, and L5L6 seeds have been implemented so far.");
...
// kMaxProc - 1 iterations are actually used for processing stub pairs.
    ...
    TC::Types::nSP iSP = i;
    bool done;
    TC::getIndices<NSPMem, isDiskSeed<Seed>()>(bx, stubPairs, iSPMem, iSP, done);

    if (!done) {
// Retrieve the inner and outer stubs for this stub pair, determining which
// all-stubs memory to use based on iSPMem:
      const typename StubPair<isDiskSeed<Seed>()>::SPInnerIndex innerIndex = stubPairs[iSPMem].read_mem(bx, iSP).getInnerIndex();
      const typename StubPair<isDiskSeed<Seed>()>::SPOuterIndex outerIndex = stubPairs[iSPMem].read_mem(bx, iSP).getOuterIndex();
      ...
      if ((Seed == TF::D1D2) || (Seed == TF::D3D4)) {
        const bool negZ = stubPairs[iSPMem].read_mem(bx, iSP).getNegZ();
        TC::processStubPair<Seed, TPROJMaskBarrel<Seed, iTC>(), TPROJMaskDisk<Seed, iTC>()>(bx, innerIndex, innerStub, outerIndex, outerStub, TCID, trackletIndex, trackletParameters, projout_barrel_ps, projout_barrel_2s, projout_disk, npar, nproj_barrel_ps, nproj_barrel_2s, nproj_disk, negZ);
      }
      else {
        TC::processStubPair<Seed, TPROJMaskBarrel<Seed, iTC>(), TPROJMaskDisk<Seed, iTC>()>(bx, innerIndex, innerStub, outerIndex, outerStub, TCID, trackletIndex, trackletParameters, projout_barrel_ps, projout_barrel_2s, projout_disk, npar, nproj_barrel_ps, nproj_barrel_2s, nproj_disk, 0);
      }
    }
  }
